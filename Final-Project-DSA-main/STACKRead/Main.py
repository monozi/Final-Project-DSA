...
#TEST ONLY 
# home_upload_outer = customtkinter.CTkFrame(home_frame, width=120, height=120, fg_color="#614D40", corner_radius=0)
# home_upload_outer.place(x = 270, y = 80)

# home_upload_inner = customtkinter.CTkFrame(home_upload_outer, width=120, height=120, fg_color="#614D40", corner_radius=0)
# home_upload_inner.place(x = 270, y = 80)
...
button_stackread_img = customtkinter.CTkImage((Image.open("D:\Downloads\Final-Project-DSA-main\STACKRead\icons\stackreadicon.png")),size=(50,50))
...
label_title_img = customtkinter.CTkImage(Image.open('D:\Downloads\Final-Project-DSA-main\STACKRead\icons\logo.png'),size=(145,20))
...
# Buttons for sidebar
button_home_img = customtkinter.CTkImage((Image.open("D:\Downloads\Final-Project-DSA-main\STACKRead\icons\homeunclicked.png")),size=(50,50))
...
button_lithit_img = customtkinter.CTkImage((Image.open("D:\Downloads\Final-Project-DSA-main\STACKRead\icons\markbookunclicked.png")),size=(50,50))
...
button_search_img = customtkinter.CTkImage((Image.open("D:\Downloads\Final-Project-DSA-main\STACKRead\icons\searchunclicked.png")),size=(50,50))
...
button_library_img = customtkinter.CTkImage((Image.open("D:\Downloads\Final-Project-DSA-main\STACKRead\icons\libraryunclicked.png")),size=(50,50))
...
button_addbooks_img= customtkinter.CTkImage((Image.open("D:\Downloads\Final-Project-DSA-main\STACKRead\icons\disclickedaddbooks.png")),size=(50,50))
